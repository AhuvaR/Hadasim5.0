...
(33, 'Avraham', 'Cohen', 'male', 1, 2, NULL), -- אח חדש
(34, 'Leah', 'Cohen', 'female', 1, 2, NULL), -- אחות חדשה


(35, 'Esther', 'Levi', 'female', 3, 4, NULL); -- אחות חדשה
*/
...
--אני התייחסתי לזה שבטבלה הראשונה בהכרח קיימים לאדם שברשומה הקוד של האבא האמא ובן/בת זוג (כאשר הם לא null)
